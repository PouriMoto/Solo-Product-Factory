...
Status: Draft
Purpose:
این فایل شامل تصمیم‌هایی است که در بازبینی Vibe Coding Standard به دست آمده‌اند اما هنوز وارد استاندارد اصلی نشده‌اند.
این موارد بعداً باید بررسی، اولویت‌بندی و در فایل‌های مربوطه ادغام شوند.
